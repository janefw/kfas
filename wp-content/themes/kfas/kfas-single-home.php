...
<!--<h2>What we do</h2>-->
	...
	<div id="large-home"><!--The full screen version with picture-->
		...
		<p style="font-size: 70%">We love having an office in a turret.</p>
	</div>
...
<h2>How we can help?</h2>
	...
	<section class ="entry-content clearfix"><!--Service intro section-->
		...
		<div class="sixcol last comp">
		<p><i class="fa-question icon-4x pull-left" style="color:#6699cc"></i></p>
		<p>If this isn't you and your business at the moment then don't worry, we've still got some great stuff for you.</p>
		<p>Take a look at <a href="<?php echo home_url(); ?>/blog">our popular blog</a> for lots of information and explanations to help you understand your business finances.</p>
		</div>
...
</section> <!--end of SERVICES section, three columns -->
...
<div class="about-container clearfix page">
	...
	<!--<h3>We think you've probably got enough to worry about, so we'll fit in with you</h3>-->
		...
		<h5>Getting you organised</h5>
		<i class="fa-puzzle-piece icon-4x"></i>
		</div>
	
		<div class="fourcol about">
		<h5>Keeping you in the know</h5>
...
<div class ="contact-container clearfix page">
	...
	<p>From Derby and Matlock Bath on the A6, the office entrance is just before Olde English Road / Derwent Avenue on the right, between Monk Bar and the Chinese. From Bakewell on the A6 the office entrance is on the left. Car parking is available outside the office (max 40 minutes) or in the public car park on Olde English Road.</p>		

	<ul>
		<li class = "footer"><a href="http://www.facebook.com/KFAccountingServices/"><i class="icon-facebook-sign icon-2x"></i> Chat on Facebook</a></li>
		<li class = "footer"><a href="http://www.twitter.com/kfaccounting/" target="_blank"><i class="icon-twitter-sign icon-2x"></i> Say Hello on Twitter</a></li>
	</ul>	
	</div>				
